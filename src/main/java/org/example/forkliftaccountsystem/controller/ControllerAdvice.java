...
import org.example.forkliftaccountsystem.exception.ExceptionBody;
...
public class ControllerAdvice {
    ...
    @ExceptionHandler(IncidentsExistException.class)
    public ResponseEntity<ExceptionBody> handleIncidentsExist(IncidentsExistException e){
